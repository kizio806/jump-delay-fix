...
This branch (`support/1.21.9-1.21.11`) targets the **1.21.x** Minecraft patch line.
...
2. Ensure you have the correct mod loader installed (Fabric + Fabric API, or NeoForge) for your Minecraft version.
